  ...
  return (
    <div>
      <div className="bg-[#FFF]">
        ...
        >
          <p className="animationHeader1 text-[56px] leading-[76px] text-[#FFF] font-bold">
            언론사의 미래,
            <br /> Presscon <span className="text-[#1C6BFF]">Ai</span> 로 혁신을
            경험하세요!
          </p>

          <p className="animationHeader1 text-[20px] leading-[28px] font-medium text-[#C2C5D4] mt-[36px]">
          ...
          <div className="flex justify-center gap-[48px] mt-[160px]">
            <div
              className="animationHeader1 hover:-translate-y-6 rounded-[20px] pt-[32px] pl-[32px] pr-[20px] pb-[20px] max-w-[367px] w-full max-h-[382px] h-full text-left border-[3px] border-[#FFF] border-opacity-[0.13]"
              style={{
            ...
            <div
              className="animationHeader2 hover:-translate-y-6 rounded-[20px] pt-[32px] pl-[32px] pr-[20px] pb-[20px] max-w-[367px] w-full max-h-[382px] h-full text-left border-[3px] border-[#FFF] border-opacity-[0.13]"
              style={{
                background: "rgba(255, 255, 255, 0.13)",
                backdropFilter: "blur(65px)",
              }}
            ...
            <div
              className="animationHeader3 hover:-translate-y-6 rounded-[20px] pt-[32px] pl-[32px] pr-[20px] pb-[20px] max-w-[367px] w-full max-h-[382px] h-full text-left border-[3px] border-[#FFF] border-opacity-[0.13]"
              style={{
                background: "rgba(255, 255, 255, 0.13)",
                backdropFilter: "blur(65px)",
              }}
        ...
        <div id="ourStrength" className="bg-[#F1F6FF] mt-[66px] py-[120px]">
          <div className="max-w-[1440px] w-full mx-auto">
            ...
            <div className="flex mt-[60px]">{/* <OurStrength /> */}</div>
          </div>
        </div>
        ...
        <div id="business" className="bg-[#F1F6FF] py-[120px]">
